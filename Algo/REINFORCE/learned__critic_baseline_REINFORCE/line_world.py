...
def REINFORCE_with_learned_baseline(env: LineWorld, max_iter_count: int = 10000,
                                    gamma: float = 0.99,
                                    alpha_pi: float = 0.01,
                                    alpha_v: float = 0.01):
...
pi, v, scores, steps = REINFORCE_with_learned_baseline(LineWorld(), max_iter_count=10000)
print(pi.weights)
print(scores)
